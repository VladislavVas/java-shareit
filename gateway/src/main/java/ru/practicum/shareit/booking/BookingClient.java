...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> getSortedListBookingByUserId(long userId, State state, Integer from, Integer size) {
    ...
    public ResponseEntity<Object> getListBookingByOwnerId(long ownerId, State state, int from, int size) {
        Map<String, Object> parameters = Map.of(
                "state", state,
                "from", from,
                "size", size
